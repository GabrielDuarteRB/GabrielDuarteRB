...
Desenvolvedor **Full Stack** com forte foco em **desenvolvimento backend**, **arquitetura de sistemas** e **construção de aplicações escaláveis**, **bem estruturadas** e **robustas**.
1. 🎓 Estudante de **Sistemas de Informação**
2. 💼 Stack principal: **PHP, Laravel, NestJS, MySQL, Vue.js, React.js**
3. 🧠 Interesses: **Arquitetura de Software, APIs, Design de Sistemas**
